...
def test_low_rank_matrices():
    ...
    S, V = solver_with_sym.build_matrices(two_distant_buoys.mesh, two_distant_buoys.mesh, 0.0, -np.infty, 1.0, solver_with_sym.green_function)
...
def test_array_of_spheres():
    ...
    fullS, fullV = nemoh_without_sym.build_matrices(array.mesh, array.mesh, 0.0, -np.infty, 1.0, nemoh_without_sym.green_function)
    S, V = nemoh_with_sym.build_matrices(array.mesh, array.mesh, 0.0, -np.infty, 1.0, nemoh_without_sym.green_function)
