...
@pytest.mark.parametrize("gf_and_method", [(cpt.Delhommeau(), "direct"), (cpt.Delhommeau(), "indirect"), (cpt.FinGreen3D(), "direct")])
def test_mccamy_and_fuchs(k, gf_and_method):
    h = 1.0  # Water depth
