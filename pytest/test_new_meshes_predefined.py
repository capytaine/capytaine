...
def test_mesh_disk():
    from capytaine.new_meshes.predefined.cylinders import mesh_disk
...
def test_mesh_vertical_cylinder():
    from capytaine.new_meshes.predefined.cylinders import mesh_vertical_cylinder
...
def test_mesh_horizontal_cylinder():
    from capytaine.new_meshes.predefined.cylinders import mesh_horizontal_cylinder
...
def test_mesh_parallelepiped():
    from capytaine.new_meshes.predefined.rectangles import mesh_parallelepiped
