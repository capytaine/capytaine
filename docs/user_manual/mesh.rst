...
+==================+==============================+==================================================================================================================================+
| Nemoh            | ``'nemoh'``, ``'mar'``       | `Page 19 of Nemoh 3 manual <https://gitlab.com/api/v4/projects/41313230/packages/generic/nemoh/v3.0.1/Nemoh_Manual_v3.0.1.pdf>`_ |
+------------------+------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
| WAMIT            | ``'wamit'``, ``'gdf'``       | `Chapter 6 of WAMIT manual <https://www.wamit.com/manual7.x/html/wamit_v75manualch6.html>`_                                      |
+------------------+------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
| HAMS             | ``'hams'``, ``'pnl'``        | `Examples in HAMS repository <https://github.com/YingyiLiu/HAMS>`_                                                               |
+------------------+------------------------------+----------------------------------------------------------------------------------------------------------------------------------+
...
<https://docs.python.org/3/library/compression.zstd.html>`_ files::
