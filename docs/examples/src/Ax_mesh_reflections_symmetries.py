...
new_simple_symmetric_mesh = ReflectionSymmetricMesh(half=half_mesh, plane="yOz", name="new_simple_symmetric_mesh")
new_nested_symmetric_mesh = ReflectionSymmetricMesh(half=ReflectionSymmetricMesh(half=quarter_mesh, plane="xOz"), plane="yOz", name="new_nested_symmetric_mesh")

# new_simple_symmetric_mesh.show()

for mesh in [reference_mesh, new_simple_symmetric_mesh, new_nested_symmetric_mesh]:
