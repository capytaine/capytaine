...
from capytaine.matrices.block_toeplitz_matrices import BlockSymmetricToeplitzMatrix, EvenBlockSymmetricCirculantMatrix, OddBlockSymmetricCirculantMatrix
